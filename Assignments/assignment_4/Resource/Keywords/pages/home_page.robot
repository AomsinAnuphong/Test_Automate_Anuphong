...
Verify empty todo list
    ...
    ...    locator=${home_page_locator['txt_empty_todo_msg']}
    ...    timeout=${10s_TIMEOUT}
...
Verify landing on home page
    AppiumLibrary.Wait Until Element Is Visible
    ...    locator=${home_page_locator['txt_minimal_title']}
    ...    timeout=${10s_TIMEOUT}

Verify todo name
    [Arguments]    ${todo_name}
    ${new_locator}=    String.Replace String
    ...    string=${home_page_locator['todo_list_with_text']}
    ...    search_for=@#string@#
...
verify todo date and time
    ...
    ${new_locator}=    String.Replace String
    ...    string=${home_page_locator['todo_list_with_time']}
    ...    search_for=@#date@#
...
Verify deleted todo sucess
    AppiumLibrary.Wait Until Element Is Visible
    ...    locator=${home_page_locator['txt_delete_todo']}
    ...    timeout=${10s_TIMEOUT}
