...
Verify todo name date and time
    ...
    ${new_locator}=    String.Replace String    string=${home_page_locator['full_todo_name_date_time']}    search_for=@#string@#    replace_with=${todo_name}
    ${new_locator}=    String.Replace String        string=${new_locator}    search_for=@#date@#    replace_with=${todo_date}
