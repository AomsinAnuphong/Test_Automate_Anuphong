...
Close warning popup if it appears
    ...
    ${is_appears}=    BuiltIn.Run Keyword And Return Status        AppiumLibrary.Wait Until Element Is Visible    locator=${home_page_locator['warning_popup']}    timeout=${10s_TIMEOUT}
    IF    ${is_appears}
